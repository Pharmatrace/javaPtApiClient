...
/**
 * API tests for ActivitysApi
 */
@Ignore
public class ActivitysApiTest {

    private final ActivitysApi api = new ActivitysApi();
     ...
     */
    @Test
    public void addActivityTest() throws ApiException {
        Activity activity = null;
        Activity response = api.addActivity(activity);
     ...
     */
    @Test
    public void findActivityByIdTest() throws ApiException {
        Long id = null;
        Activity response = api.findActivityById(id);
     ...
     */
    @Test
    public void findActivitysTest() throws ApiException {
        List<String> tags = null;
        Integer limit = null;
        List<Activity> response = api.findActivitys(tags, limit);
