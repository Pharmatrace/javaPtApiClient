...
public class ProfilesApiTest {
    ...
    public void addProfileTest() throws ApiException {
        ...
        Profile response = api.addProfile(profile);
     ...
     */
    @Test
    public void findProfileByIdTest() throws ApiException {
        Long id = null;
        Profile response = api.findProfileById(id);
     ...
     */
    @Test
    public void findProfilesTest() throws ApiException {
        List<String> tags = null;
        Integer limit = null;
        List<Profile> response = api.findProfiles(tags, limit);
