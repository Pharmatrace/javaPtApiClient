...
public class TradesApiTest {
     ...
     */
    @Test
    public void addTradeTest() throws ApiException {
        Trade trade = null;
        Trade response = api.addTrade(trade);
     ...
     */
    @Test
    public void deleteTradeTest() throws ApiException {
        Long id = null;
        api.deleteTrade(id);
     ...
     */
    @Test
    public void findTradeByIdTest() throws ApiException {
        Long id = null;
        Trade response = api.findTradeById(id);
     ...
     */
    @Test
    public void findTradesTest() throws ApiException {
        List<String> tags = null;
        Integer limit = null;
        List<Trade> response = api.findTrades(tags, limit);
